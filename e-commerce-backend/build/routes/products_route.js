...
productsRouter.get("/", [query("page").isNumeric().notEmpty().trim().escape()], ProductsController.getProducts);
productsRouter.get("/filter", [
    ...
    query("product_category").isString().optional().escape().trim(),
...
productsRouter.get("/:product_id", [param("product_id").isNumeric().notEmpty()], ProductsController.getProductById);
